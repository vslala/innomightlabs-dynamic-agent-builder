...
write_kv "openai_image_generation_models" "$(get_var 'OPENAI_IMAGE_GENERATION_MODELS')"
...
echo "📍 Output: $TFVARS_PATH"
echo ""
echo "Summary:"
echo "  - Environment: $ENVIRONMENT"
echo "  - Frontend URL: $(get_var 'FRONTEND_URL')"
echo "  - API Domain: $(get_var 'API_DOMAIN')"
echo "  - Stripe Mode: $(if [[ $(get_var 'STRIPE_SECRET_KEY') == sk_live_* ]]; then echo 'LIVE ⚠️'; else echo 'TEST'; fi)"
