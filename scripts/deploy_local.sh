...
export DOWNLOADS_ARTIFACTS_BUCKET="${LOCAL_DOWNLOADS_ARTIFACTS_BUCKET:-${DOWNLOADS_ARTIFACTS_BUCKET:-innomightlabs-artifacts}}"
export DOWNLOADS_ARTIFACTS_REGION="${LOCAL_DOWNLOADS_ARTIFACTS_REGION:-${DOWNLOADS_ARTIFACTS_REGION:-us-east-1}}"
export DOWNLOADS_MANIFEST_KEY="${LOCAL_DOWNLOADS_MANIFEST_KEY:-${DOWNLOADS_MANIFEST_KEY:-artifacts/plugins/manifest.json}}"
export DOWNLOADS_PRESIGN_TTL_SECONDS="${LOCAL_DOWNLOADS_PRESIGN_TTL_SECONDS:-${DOWNLOADS_PRESIGN_TTL_SECONDS:-900}}"
