...
export PINECONE_API_KEY="${LOCAL_PINECONE_API_KEY:-pclocal}"
export PINECONE_HOST="${LOCAL_PINECONE_HOST:-http://localhost:5081}"
export PINECONE_INDEX="${LOCAL_PINECONE_INDEX:-local-knowledge}"
export EMBEDDING_BACKEND="${LOCAL_EMBEDDING_BACKEND:-ollama}"
export EMBEDDING_DIMENSION="${LOCAL_EMBEDDING_DIMENSION:-1024}"
export OLLAMA_BASE_URL="${LOCAL_OLLAMA_BASE_URL:-http://localhost:11434}"
export OLLAMA_EMBEDDING_MODEL="${LOCAL_OLLAMA_EMBEDDING_MODEL:-qwen3-embedding:0.6b}"
export OLLAMA_TIMEOUT_SECONDS="${LOCAL_OLLAMA_TIMEOUT_SECONDS:-120}"
...
export CLI_RUNNER_BASE_URL="$(get_var_default 'CLI_RUNNER_BASE_URL' "http://localhost:${LOCAL_CLI_RUNNER_PORT:-8002}")"
export CLI_RUNNER_SHARED_TOKEN="$(get_var_default 'CLI_RUNNER_SHARED_TOKEN' 'local-cli-runner-token')"
export CLI_RUNNER_TIMEOUT_SECONDS="$(get_var_default 'CLI_RUNNER_TIMEOUT_SECONDS' '30')"
export CLI_RUNNER_MAX_TIMEOUT_SECONDS="$(get_var_default 'CLI_RUNNER_MAX_TIMEOUT_SECONDS' '120')"
...
echo "  PINECONE_HOST: $PINECONE_HOST"
echo "  OLLAMA_BASE_URL: $OLLAMA_BASE_URL"
echo "  CLI_RUNNER_BASE_URL: $CLI_RUNNER_BASE_URL"
